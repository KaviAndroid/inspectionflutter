...
class LoginState extends State<Login> {
                                          ...
                                          if (user_password.text.isNotEmpty) {
                                            ...
                                            if (await utils.isOnline()) {
                                              ...
                                              if(prefs.getString(s.key_user_name)!=null&&prefs.getString(s.key_user_pwd)!=null){
                                                if(user_name.text== prefs.getString(s.key_user_name)){
                                                  callLogin(context);
                                                }else{
  ...
  Future<void> showLogoutLoginAlert(
                            ...
                            child: RichText(
                              text: new TextSpan(
                                ...
                                style: GoogleFonts.getFont('Roboto',
                                    ...
                                    color: c.grey_8),
                                children: <TextSpan>[
                                  new TextSpan(text: "Already you have login with ",style: new TextStyle(fontWeight: FontWeight.normal,color: c.grey_8)),
                                  new TextSpan(text: prefs.getString(s.key_user_name),style: new TextStyle(fontWeight: FontWeight.normal,color: c.primary_text_color2)),
                                  new TextSpan(text: ". Click below Logout & Continue button to login with ",style: new TextStyle(fontWeight: FontWeight.normal,color: c.grey_8)),
                                  new TextSpan(text: user_name.text,style: new TextStyle(fontWeight: FontWeight.normal,color: c.primary_text_color2)),
                                  new TextSpan(text: ". It may leads to loss of offline data of previous login!",style: new TextStyle(fontWeight: FontWeight.bold,color: c.subscription_type_red_color)),
                                ],
                              ),
                            ),
                          ),
