...
Uri login = Uri.parse(
    'http://10.163.19.137:8090/tnrd/project/webservices_forms/login_service/login_services.php');
Uri master_service = Uri.parse(
    'http://10.163.19.137:8090/tnrd/project/webservices_forms/master_services/master_services_v_1_6.php');
...
// Uri main_service_jwt = Uri.parse(
//     'https://tnrd.tn.gov.in/project/webservices_forms/work_inspection/inspection_services_v_1_6_jwt.php');
