...
Uri master_service = Uri.parse('$endPointURL/master_services/master_services_v_1_6.php');
Uri main_service_jwt = Uri.parse('$endPointURL/work_inspection/inspection_services_v_1_9_jwt.php');
Uri pdf_URL = Uri.parse('$endPointURL/work_inspection/getInspectionPDF.php');
