...
class _WorkListState extends State<WorkList> {
  ...
  Map<String, String> defaultSelectedMonth = {
    'monthId': "00",
    'month': '0'
  };
  ...
  Future<void> initialize() async {
    ...
    if (widget.flag == 'filter') {
      ...
      selectedScheme = widget.scheme;
      schemeFlag = true;
      await getWorkListByTMC(widget.dcode, widget.tmccode, widget.townType, widget.selectedschemeList, widget.finYear);
  ...
  Widget build(BuildContext context) {
                                ...
                                if (value != "0") {
                                  ...
                                  selectedScheme = value.toString();
                                      if (widget.flag == 'filter') {
                                        ...
                                        schemeArray.add(map);
                                   await getWorkListByTMC(widget.dcode, widget.tmccode, widget.townType, schemeArray, widget.finYear);
                                }else if (widget.flag == 'tmc_offline') {
                                        await fetchOfflineWorkList(areaType,selectedScheme);
                                }
                      ...
                      child: GestureDetector(
                        ...
                        child: Container(
                            ...
                            decoration: BoxDecoration(
                                ...
                                border: Border.all(
                                    width: all ? 0 : 2, color: c.colorPrimary),
                      ...
                      child: GestureDetector(
                        ...
                        child: Container(
                            ...
                            decoration: BoxDecoration(
                                ...
                                border: Border.all(
                                    width: delay ? 0 : 2, color: c.colorPrimary),
                                borderRadius: BorderRadius.circular(10),
                                boxShadow: const [
                                  BoxShadow(
                                    color: Colors.grey,
                   ...
                   Container(
                     decoration: BoxDecoration(
                        ...
                        children: [
                          Padding(
                            padding:
                            const EdgeInsets.only(top: 10, bottom: 10,left: 5,right: 0),
                            child: Text(
                              'Month >=',
                              style: GoogleFonts.getFont('Raleway',
                                  fontWeight: FontWeight.w800,
                                ...
                                child: DropdownButton2(
                                  ...
                                  onChanged: (value) async {
                                    if (value != "00") {
                                      ...
                                      await fetchWorkList('month',selectedMonth);
                                      setState(() {});
                                    } else {
                                      setState(() {
                                        selectedMonth = value.toString();
                                                  ...
                                                  children: [
                                                    Row(
                                                      children: [
                                                        InkWell(
                                                          onTap: () async {
                                                            await getProgressDetails(workList[index]
                                                            [
                                                            s.key_work_id]
                                                                .toString());
                                                              ...
                                                              Expanded(
                                                                ...
                                                                Container(
                                                                  ...
                                                                  Align(
                                                                    ...
                                                                    AlignmentDirectional.topStart,
                                                                    child: ExpandableText(
                                                                        workList[index][s.key_townpanchayat_name]
                                                                            .toString(),
                                                                        trimLines:
                                                                        2),
                                                                  ),
                                                              ...
                                                              Expanded(
                                                                ...
                                                                Container(
                                                                  ...
                                                                  Align(
                                                                    ...
                                                                    AlignmentDirectional.topStart,
                                                                    child: ExpandableText(
                                                                        workList[index][s.key_municipality_name]
                                                                            .toString(),
                                                                        trimLines:
                                                                        2),
                                                                  ),
                                                              ...
                                                              Expanded(
                                                                ...
                                                                Container(
                                                                  ...
                                                                  Align(
                                                                    ...
                                                                    AlignmentDirectional.topStart,
                                                                    child: ExpandableText(
                                                                        workList[index][s.key_corporation_name]
                                                                            .toString(),
                                                                        trimLines:
                                                                        2),
                                                                  ),
                                                            ...
                                                            Expanded(
                                                              ...
                                                              Container(
                                                                ...
                                                                Align(
                                                                  ...
                                                                  AlignmentDirectional.topStart,
                                                                  child: ExpandableText(
                                                                      workList[index][s.key_work_order_date]
                                                                          .toString(),
                                                                      trimLines:
                                                                      2),
                                                                ),
    ...
    ListView.builder(
        shrinkWrap: true,
    itemCount: progressList == null ? 0 : progressList.length,
    itemBuilder: (BuildContext context, int index) {
  ...
  Future<void> fetchWorkList(String type,String val) async{
    ...
    for (int i = 0; i < workListAll.length; i++) {
      ...
      if (workListAll[i][s.key_current_stage_of_work] == 11) {
        ...
        if(  await utils.delayHours(context, workListAll[i][s.key_upd_date], int.parse(val)) ){
          if (workListAll[i][s.key_current_stage_of_work] == 11) {
            completedWorkList.add(workListAll[i]);
          } else {
            ongoingWorkList.add(workListAll[i]);
  ...
  Future<void> fetchOfflineWorkList(String areatype,String scheme) async{
    ...
    print("SELECT * FROM ${s.table_RdprWorkList} where rural_urban='${areatype}' and scheme_id='${scheme}' ");
    flagTab = true;
    flagList=true;
    ongoingWorkList = [];
    completedWorkList = [];
