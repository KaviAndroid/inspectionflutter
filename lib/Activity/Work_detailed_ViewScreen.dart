...
class Work_detailed_ViewScreen extends StatefulWidget {
  ...
  Work_detailed_ViewScreen(
      {this.selectedRDPRworkList,
      this.flag,
      this.imagelist,
      this.selectedOtherWorkList,
      this.selectedATRWorkList,
      this.town_type});
  State<Work_detailed_ViewScreen> createState() =>
      Work_detailed_ViewScreenState();
}
                                                      ...
                                                      Row(
                                                        ...
                                                        children: [
                                                          ...
                                                          Expanded(
                                                            flex: 1,
                                                            child: Text(
                                                                other_work_inspection_id = widget
