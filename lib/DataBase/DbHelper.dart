...
class DbHelper {
  ...
  void onCreate(Database db, int version) async {
    ...
    await db.execute("CREATE TABLE $table_PlannedDelayWorkList ( rural_urban TEXT ,town_type TEXT , dcode TEXT, dname TEXT , bcode TEXT, bname TEXT, pvcode TEXT, pvname TEXT, hab_code TEXT, scheme_group_id TEXT, scheme_id TEXT, scheme_name TEXT, work_group_id TEXT, work_type_id TEXT, fin_year TEXT, work_id TEXT, work_name TEXT, as_value TEXT, ts_value TEXT, current_stage_of_work TEXT, is_high_value TEXT, stage_name TEXT, as_date TEXT, ts_date TEXT, work_order_date TEXT, work_type_name TEXT, tpcode TEXT, townpanchayat_name TEXT, muncode TEXT, municipality_name TEXT, corcode TEXT, corporation_name TEXT, upd_date TEXT )");
  ...
  void delete_table_PlannedDelayWorkList(String type) {
    type == "ALL"
        ? myDb?.execute("DELETE FROM $table_PlannedDelayWorkList")
        :
        // you can execute drop table and create table
        myDb?.execute(
            "DELETE FROM $table_PlannedDelayWorkList where rural_urban = '$type'");
  }
  ...
  Future<void> deleteAll() async {
    ...
    delete_table_PlannedDelayWorkList("ALL");
  ...
  void dropAllTable(Database db) {
    ...
    db.execute('DROP TABLE IF EXISTS $table_PlannedDelayWorkList');
