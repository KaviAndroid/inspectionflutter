    ...
    return MultiProvider(
        providers: [
          ChangeNotifierProvider(
              create: (_) => AtrSaveDataController(
                  widget.rural_urban,
                  widget.onoff_type,
                  widget.selectedWorklist,
                  widget.flag,
                  widget.imagelist))
        ],
        child: Scaffold(
            ...
            body:
                Consumer<AtrSaveDataController>(builder: (context, ref, child) {
              refer = ref;
              return Container(
                      ...
                      Card(
                        ...
                        child: Column(
                          ...
                          children: [
                            Expanded(
                              child: InkWell(
                                onTap: () {
                                  if (widget.flag == "edit") {
                                    utils.showAlert(
                                        context, "Image can't edit");
                                  } else {
                                    refer.goToCameraScreen(index, context);
                                  }
                                },
                                child: refer.img_jsonArray[index]['image'] ==
                                        '0'
                                    ? Container(
                            ...
                            InkWell(
                              onTap: () {
                                if (refer.img_jsonArray[index]['image'] !=
                                        null &&
                                    refer.img_jsonArray[index]['image']
                                            .toString() !=
                                        '0') {
                                  refer.showAlert(
                                      context,
